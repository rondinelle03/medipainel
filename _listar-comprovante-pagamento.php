          ...
          <div class="">
           <div class="page-title">
            <div class="title_left">
              <h3>Listar Ordem de Pagamento</h3>
            </div>
<!--
          ...
          <div class="clearfix"></div>
            ...
            <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Ordem de pagamentos criadas</h2>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="right-icons"> <a href="" title="Editar"><i class="fa fa-pencil-square-o"></i></a> <a href="" title="Deletar"><i class="fa fa-trash"></i></a></td>
                        </tr>
                        <tr>
                          <td>002</td> 
                          <td>31.01.2021</td>
